...
function App:build_frame()BaseApp.build_frame(self)local menubutton=rtk.OptionMenu{xicon='med-edit',icon='snow:medium',flat=true,icononly=true,tooltip='Manage banks',}if rtk.os.windows then
...
self:update_dock_buttons()local icon=rtk.Image.icon('settings:medium')local icon=rtk.Image.icon('settings:medium')local button=toolbar:add(rtk.Button{icon=icon, flat=true, tooltip='Manage Reaticulate Settings'})button.onclick=function()self:push_screen('settings')end
end
...
__mod_screens_banklist_sync_conflict_20220118_203048_FDNNBRS=(function()
local rtk=rtk
local rfx=__mod_rfx
local reabank=__mod_reabank
local feedback=__mod_feedback
